    ...
    <div class="container-fluid">
        <div class="row">
            ...
            function generate_index($html_output) {
                ...
                $html_output .= "<div class=\"col-lg-12 col-xl-3\">"
                        . "<div class=\"row\">"
            ...
            function generate_search($html_output) {
                ...
                $html_output .= "<div class=\"navb-search col-lg-12 col-xl-7\">"
            ...
            function generate_catalogue($html_output) {
                ...
                $html_output .= "<div class=\"navb-items col-lg-12 col-xl-5\">"
                ...
                if (sizeof($category_array) == 0) {
                    ...
                    $html_output .= "<div class=\"item nav-item dropdown\">"
            ...
            function generate_cart($html_output) {
                ...
                $html_output .= "<div class=\"item nav-item\">"
